...
> **⚠️ APRÈS push Abdou + déploiement Vercel : Claude applique en PROD la mig 118 (V5) PUIS la mig 119 (B8)** via `backups/.db_password`, transaction atomique, lockstep, vérif AVANT/APRÈS (même procédure que 117).
