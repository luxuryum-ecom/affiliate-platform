/**
 * Config Playwright dédiée aux captures P0 trésorerie/réconciliation
 * (/admin/remittances + /admin/treasury) en FR/AR/EN.
 *
 ...
 *
 * Pré-requis : « supabase start » + « node scripts/seed-p0-captures-local.mjs --seed »
 */
...
const PORT = 3300 // port dédié — n'entre pas en collision avec 3000/3200
const BASE_URL = `http://localhost:${PORT}`

export default defineConfig({
  testDir: './e2e',
  testMatch: /p0-captures\.spec\.ts/,
  fullyParallel: false,
  forbidOnly: false,
  retries: 0,
  workers: 1,
