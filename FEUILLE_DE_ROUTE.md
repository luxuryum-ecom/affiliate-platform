...
3. **Déploiement staging Vercel** — SEULEMENT une fois le Lot 4 complet **ET** la purge money faite. URL fixe, build prod, auto-deploy sur push.
4. **PR vers `main`** — SEULEMENT après Lot 4 complet, purge money **ET** staging en ligne. C'est
