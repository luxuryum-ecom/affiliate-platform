...
export async function WholesaleSavingsHook({
  tiers,
  unitLabel,
}: {
  tiers: WholesaleTier[]
   ...
   * non fourni → défaut = clé i18n `savingsUnit` (« pièces ») → comportement
   * STRICTEMENT inchangé pour les produits sans unité de vente.
   */
  unitLabel?: string
}) {
